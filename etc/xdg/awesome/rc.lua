...
beautiful.init("/usr/share/awesome/themes/muted-dream-tree/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "x-terminal-emulator"
editor = os.getenv("EDITOR") or "editor"
editor_cmd = "sudo gedit "
...
myawesomemenu = {
   ...
   { "edit config", editor_cmd .. " " .. "/etc/xdg/awesome/rc.lua" },
...
textbox = widget({type="textbox"})
textbox.text = "<b>syfluqs@JARVIS</b> "
...
awful.util.spawn("sh /home/knoppix/scripts/awStart.sh")
awful.util.spawn("ktouch")
