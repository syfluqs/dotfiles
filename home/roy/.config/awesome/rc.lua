...
--posix.setEnv("PATH", posix.getEnv("PATH") .. ":/home/user/bin")
require("vain")
-- }}}
...
-- autostart bluetooth and nm-applet
run_once("nm-applet")
run_once("blueberry-tray")
run_once("pasystray")
--disable touchpad while typing
run_once("syndaemon -d -i 0.2 -k")
run_once("xpad")
...
-- {{{ Wallpaper
-- overiding wallpaper
-- beautiful.wallpaper = "/home/roy/Downloads/wallhaven-436216.jpg"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "e", function () awful.spawn(browser2) end),
...
awful.rules.rules = {
    ...
    { rule = { instance = "termite" },
     ...
     { rule = {name = "Toolbox - Tool Options" },
        callback = function (c)
            c.ontop = true
        end
        },

    { rule = {name = "Layers - Brushes" },
        callback = function (c)
            c.ontop = true
        end
        },
    ...
    { rule = { class = "Sublime Color Picker" },
        callback = function (c)
            awful.placement.centered(c, nil)
            end
        },
    ...
    { rule = { class = "Vlc" },
           --properties = { floating = true },
           callback = function (c)
             awful.placement.top_left(c,nil)
           end
         },
