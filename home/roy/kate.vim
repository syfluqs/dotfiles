...
hi PreProc      gui=NONE		guifg=#0057AE		guibg=NONE	
...
hi Visual       gui=none     guifg=Black          guibg=#EEF6FF
hi MatchParen   gui=bold        guifg=Black         guibg=#FFFF99
hi Question     gui=NONE        guifg=Blue     guibg=NONE
hi More         gui=bold        guifg=Blue     guibg=NONE
